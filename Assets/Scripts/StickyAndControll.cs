...
public class StickyAndControll : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Vector3 flont = me.transform.position - observer.transform.position;
        Vector3 side = Vector3.Cross(Vector3.up,flont);

        myRigidBody.AddForce(50*z*flont, ForceMode.Force);
        myRigidBody.AddForce(50*x*side, ForceMode.Force);
